...
class CalendarYearSplit(IntervalSplit):
    """
...
class CalendarQuarterSplit(IntervalSplit):
    """
    Split index by beginning of calendar quarter.
    ...
    index : range
        The range of the index to be split.
    n_train : int
        Number of training years. Example `n_train=3` is 3 quarters training set.
    n_test : int
        Number of testing years. Example `n_test=1` is 1 quarter testing set.
    allow_zero_len : bool, optional
        Allow zero length. Default is False.
    allow_zero_len : bool, optional
        Allow zero length. Default is False.

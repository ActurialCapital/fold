    ...
    def __init__(
        ...
        while True:
            ...
            if fix_ranges or split is not None:
                ...
                new_split = model.split(new_split, backwards=False)
...
class FunctionBackwardSplit(BaseModel):
    """
    Split index backwards with a custom split function.
    ...
    def __init__(
        ...
        while True:
            ...
            if fix_ranges or split is not None:
                ...
                new_split = model.split(new_split, backwards=True)
